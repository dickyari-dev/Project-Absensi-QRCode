                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-12 mb-2">
                                <a href="{{ route('atasan.data-absensi.download.excel', ['bulan' => request('bulan', $bulan), 'tahun' => request('tahun', $tahun)]) }}"
                            class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel"></i> Download Excel</a>
                            </div>
                            <div class="col-12 mb-2">
                                <a href="{{ route('atasan.data-absensi.download.pdf', ['bulan' => request('bulan', $bulan), 'tahun' => request('tahun', $tahun)]) }}"
...
<script>
    function filterData(bulan) {
        ...
        window.location.href = "{{ route('atasan.data-absensi') }}?bulan=" + bulan + "&tahun=" + tahun; // Tambahkan tahun ke URL
